...
## [0.1.6](https://github.com/OxideAV/oxideav-celt/compare/v0.1.5...v0.1.6) - 2026-05-18

### Other

- stereo dynalloc + user-settable target bitrate

## [0.1.5](https://github.com/OxideAV/oxideav-celt/compare/v0.1.4...v0.1.5) - 2026-05-11

### Other

- mixed-radix IMDCT FFT, norm-buffer top-band fix, denorm overflow guard
